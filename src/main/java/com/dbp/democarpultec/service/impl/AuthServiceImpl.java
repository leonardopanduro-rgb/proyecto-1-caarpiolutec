...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponseDto register(AuthRegisterRequestDto dto) {
        ...
        if (dto.getPhone() != null && !dto.getPhone().isBlank()
            ...
            throw new DuplicateResourceException("El telefono ya esta registrado");
        }
        if (dto.getStudentCode() != null && !dto.getStudentCode().isBlank()
                && userRepository.existsByStudentCode(dto.getStudentCode())) {
            throw new DuplicateResourceException("El codigo de estudiante ya esta registrado");
        }
